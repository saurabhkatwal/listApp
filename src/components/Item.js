...
const Item = ({ data, displayForm, openForm, deleteItem, closeForm, editId, btn1ClickHandler, editItemInList,editObj}) => {

    return (
        <div className="item">
            {displayForm && editId === data.id ? <InputClass edit={true}
                editObj={editObj}
                editId={editId}
                btn1Text="Save"
                btn2Text="Cancel"
